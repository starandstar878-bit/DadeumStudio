...
groupedPortConnectionCounts(const TTeulDocument &document,
...
static GroupedPortIssueSummary issueSummaryForConnectedEndpoint(
    const TTeulDocument &document, const TPort &port, const TEndpoint &otherEndpoint) {
...
static GroupedPortIssueSummary groupedPortIssueSummary(const TTeulDocument &document,
                                                       const TNode &node,
                                                       const GroupedNodePortSummary &group) {
...
public:
  NodePropertiesPanelImpl(TTeulDocument &docIn, TGraphCanvas &canvasIn,

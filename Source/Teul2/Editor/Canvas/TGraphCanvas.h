...
class TGraphCanvas : public juce::Component,
                     ...
                     private juce::Timer {
public:
  explicit TGraphCanvas(TTeulDocument &doc, const TNodeRegistry &registry);
  ...
  TTeulDocument &getDocument() { return document; }
  const TTeulDocument &getDocument() const { return document; }

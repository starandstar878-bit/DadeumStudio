  ...
  WidgetDescriptor makeDescriptor() const override {
    ...
    descriptor.painter = [](juce::Graphics &g, const WidgetModel &widget,
      ...
      const auto orientation =
          widget.properties
              .getWithDefault("meter.orientation", juce::var("vertical"))
              .toString()
              .trim();
    ...
    descriptor.dropOptions = [](const WidgetModel &, const AssetRef &asset) {
      ...
      return std::vector<DropOption>{
          {"Fill Image", juce::Identifier("meter.fillImage"),
           "Apply image to meter fill"},
          {"Background Image", juce::Identifier("meter.backgroundImage"),
           "Apply image to meter body"}};
    };
